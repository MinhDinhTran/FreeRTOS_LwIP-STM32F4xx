/**
  ...
  * @version V1.0.0
  * @date    09-May-2020
  * @brief  Initiliaztion SRAM and NAND
    *         the FSMC interface configuration.
  ******************************************************************************
  * @attention
...
//	/*PD0(D2),PD1(D3),PD4(NOE),PD5(NWE),PD6(NWAIT),PD7(NCE2),PD8(D13),PD9(D14),PD10(D15),PD11(CLE),PD12(ALE),PD14(D0),PD15(D1)*/
//	
...
//	
//	FSMC_NAND_PCCARDTimingInitStructure.FSMC_HiZSetupTime = 
//}
